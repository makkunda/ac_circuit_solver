    ...
    */
      ...
      */
       ...
       /* for(j=0;j<passivecount;j++)
        ...
        for(j=0;j<activecount;j++)
        {
            complex* valll = sub(temp[act[j].net2],temp[act[j].net1]);
       ...
       for(j=0;j<totalcount;j++)
       {
        ...
        for(j=0;j<passivecount;j++)
        {
            complex* valll = sub(temp[pass[j].net2],temp[pass[j].net1]);
        ...
        for(j=0;j<totalcount;j++)
        {
            if(pr[j].mtype==0)
            {
                ...
                if(pr[j].ltype==0)
                {
                    vallll->r = 1/(pr[j].val1);
                }
                else if(pr[j].ltype==1)
                {
                    vallll->c = -1/(w*pr[j].val1);
                }
                else{
                    vallll->c = 1*w*pr[j].val1;
                }
